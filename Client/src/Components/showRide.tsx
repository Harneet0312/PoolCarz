...
class ShowRide extends React.Component<Props, MyState> {
    ...
    render() {
        ...
        const newObject={...this.state.detailRide,rerenderParentCallback:this.rerenderParentCallback}
...
<div>
                         {/* //added  */}
                   <Navbar className="navigate navbar navbar-expand-lg navbar-light bg-dark" expand="lg">
                       <Nav className="ml-auto">
                           
                           <Nav.Item> <Nav.Link  className="nav-link text-white" href="/show_rides">Home</Nav.Link>
                           </Nav.Item>
                           <Nav.Item><Nav.Link  className="nav-link text-white" href="/">Logout</Nav.Link></Nav.Item>
                       </Nav>
                   </Navbar>
                ...
                <React.Fragment>
                    <Navbar className="navigate navbar navbar-expand-lg navbar-light bg-dark" expand="lg">
                       <Nav className="ml-auto">
                           ...
                           <Nav.Item><Nav.Link  className="nav-link text-white" href="/offer_ride">Offer a Ride |</Nav.Link></Nav.Item>
                           <Nav.Item><Nav.Link className="nav-link text-white" href="/">Logout</Nav.Link></Nav.Item>
                       </Nav>
                   </Navbar>
                    <div className="container-fluid">
